				...
				<div class="col-12">
					<div class="main__table-wrap">
								...
								<tr>
									...
									<td>
										<div class="main__table-btns">
                                            ...
                                            <a href="#modal-delete" class="main__table-btn main__table-btn--delete open-modal remove__user" id_user="{{$user->id}}">
                        ...
                        <div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
                            ...
                            <p class="modal__text">Bạn có chắc chắn muốn xóa người dùng này không?</p>

                            <div class="modal__btns">
                                <button class="modal__btn modal__btn--apply" id_user="{{$user->id}}" id="modal__delete__btn" type="button">Xóa</button>
