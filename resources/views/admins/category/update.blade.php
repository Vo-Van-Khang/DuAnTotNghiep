			...
			<div class="col-12">
				<div class="sign__wrap">
					<div class="">
						<!-- biểu mẫu chi tiết -->
						<div class="">
						<form action="{{ route('admin.category.update', $category->id) }}" method="POST" class="sign__form sign__form--profile sign__form--first">
								@csrf
								<div class="row">
									<div class="col-12">
									...
									<div class="col-12 col-md-6 col-lg-12 col-xl-6">
										<div class="sign__group">
											...
											<input id="username" type="text" name="id" disabled class="sign__input" value="Auto">
										</div>
									</div>
									<div class="col-12 col-md-6 col-lg-12 col-xl-6">
										<div class="sign__group">
											<label class="sign__label" for="firstname">Nội dung</label>
											<input id="firstname" type="text" value="{{$category->name}}" name="name" class="sign__input" placeholder="Nội dung">
										</div>
									</div>
									<div class="col-12 col-md-6 col-lg-12 col-xl-6">
										<div class="sign__group">
