...
@section('content')
            ...
            <div class="home__carousel owl-carousel" id="flixtv-hero">
                @foreach ($slides as $slide)
                    <div class="home__card">
                        ...
                        <div>
                            <h2>{{$slide->get_movies->title}}</h2>
                            <ul>
                               @foreach ($categories as $category)
                                   @if ($slide->get_movies->id_category == $category->id)
                                       <li>{{$category->name}}</li>
                                   @endif
                               @endforeach
                                <li>{{$slide->get_movies->release_year}}</li>
                            </ul>
                        </div>
        ...
        <section class="section section--pb0 section--gradient">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="section__title">Chọn gói của bạn</h2>
                        <p class="section__text">
                            Không có phí ẩn, thuê thiết bị hoặc lắp đặt các cuộc
                            hẹn.
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-xl-4 order-md-2 order-xl-1">
                        <div class="plan">
                            <h3 class="plan__title">Thường xuyên</h3>
                            <ul class="plan__list">
                                <li class="green">
                                    <svg
                                        width="19"
                                ...
                                <li class="green">
                                    ...
                                    Chuyển đổi gói hoặc hủy bất cứ lúc nào
                                </li>
                                <li class="red">
                                    <svg
                                        width="19"
                            ...
                            <span class="plan__price"
                                >$11.99<span>/Tháng</span></span
                            >
                            <button class="plan__btn" type="button">
                                Chọn gói
                            </button>
                        </div>
                    </div>
